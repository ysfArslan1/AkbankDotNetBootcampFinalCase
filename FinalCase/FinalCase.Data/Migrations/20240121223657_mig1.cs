        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastActivityDate = table.Column<DateTime>(type: "datetime2", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenceNotifies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpenceNotifies_ExpenceTypes_ExpenceTypeId",
                        column: x => x.ExpenceTypeId,
                        principalTable: "ExpenceTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExpenceNotifies_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    ExpenceNotifyId = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_ExpenceNotifies_Id",
                        column: x => x.Id,
                        principalTable: "ExpenceNotifies",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "ExpenceResponds",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    IsDeposited = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    Explanation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    InsertUserId = table.Column<int>(type: "int", nullable: false),
                    InsertDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateUserId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenceResponds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpenceResponds_ExpenceNotifies_ExpenceNotifyId",
                        column: x => x.ExpenceNotifyId,
                        principalTable: "ExpenceNotifies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExpenceResponds_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpencePayments", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "ExpenceResponds",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenceNotifies_ExpenceTypeId",
                table: "ExpenceNotifies",
                column: "ExpenceTypeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExpenceNotifies_UserId",
                table: "ExpenceNotifies",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExpencePayments_AccountId",
                table: "ExpencePayments",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExpencePayments_ExpenceRespondId",
                table: "ExpencePayments",
                column: "ExpenceRespondId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExpenceResponds_ExpenceNotifyId",
                table: "ExpenceResponds",
                column: "ExpenceNotifyId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExpenceResponds_UserId",
                table: "ExpenceResponds",
                column: "UserId",
                unique: true);
